...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\PatientPortal"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\Patientportal"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\patientportal"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("assets")
$filename = "entQA-lis-portal"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\Patientportal"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\Patientportal"
$webSiteName = "LIMS_ENTERPRISE_QA"
$appPoolName = "LIMS_ENTERPRISE_QA"
$numRecentBackups = 3
$numRecentLogs = 3
