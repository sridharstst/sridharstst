...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\LIMSSERVICE"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\Service"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\Service\"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename = "entQA-lis-svc"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\Service"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\Service"
