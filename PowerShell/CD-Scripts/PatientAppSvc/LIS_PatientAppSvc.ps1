...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\PatientAppService"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\PatientAppSvc"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\PatientAppSvc"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename = "entQA-lis-patientappsvc"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\PatientAppSvc"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\PatientAppSvc"
$webSiteName = "LIMS_ENTERPRISE_QA"
$appPoolName = "LIMS_ENT_QA_PatientAppSvc"
$numRecentBackups = 3
$numRecentLogs = 3
