...
$webSitePath = "R:\LIS_DEVTEST_DuMMY\WEBSITEAPP\RMGAPP\"
$backupPath = "R:\RMG_Auto\Backup\UI"
$timestamp = Get-Date -Format "HH-mm"
$logFile = "Log_$Version-$Build.log"
$logPath = "R:\RMG_Auto\Logs\Ui"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("assets", "reports")
$filename = "rmg-lis-ui"
$SourcePath = "R:\Jenkins_Release\RMG_LIS\Ui"
$localDestPath = "R:\RMG_Auto\Migrate_Dest_Path\UI"
$webSiteName = "AUto_Dummy_Ui"
$appPoolName = "AUto_Dummy_Ui"
$numRecentBackups = 3
$numRecentLogs = 3
