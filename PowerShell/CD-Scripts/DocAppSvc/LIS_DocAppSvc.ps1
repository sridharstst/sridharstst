...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\DoctorAppService"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\DocAppSvc"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\DocAppSvc\"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename = "entQA-lis-docappsvc"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\DocAppSvc"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\DocAppSvc"
$webSiteName = "LIMS_ENTERPRISE_QA"
$appPoolName = "LIMS_ENT_QA_DocAppSvc"
$numRecentBackups = 3
$numRecentLogs = 3
