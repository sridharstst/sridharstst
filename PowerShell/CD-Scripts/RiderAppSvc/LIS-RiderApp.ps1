...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\RiderAppService"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\RiderAppSvc"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\RiderAppSvc"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename ="entQA-lis-riderappsvc"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\RiderAppSvc"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\RiderAppSvc"
$webSiteName = "LIMS_ENTERPRISE_QA"
$appPoolName = "LIMS_ENT_QA_RiderAppService"
$numRecentBackups = 3
$numRecentLogs = 3
