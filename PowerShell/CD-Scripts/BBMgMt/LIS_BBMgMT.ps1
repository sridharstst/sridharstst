...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\BBMGMTSERVICE"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\BBMgMt"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\BBMgMt"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename = "entQA-lis-bbmgmt"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\BBMgMt"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\BBMgMt"
$webSiteName = "LIMS_ENTERPRISE_QA"
$appPoolName = "LIMS_ENT_QA_BBMgMt"
$numRecentBackups = 3
$numRecentLogs = 3
