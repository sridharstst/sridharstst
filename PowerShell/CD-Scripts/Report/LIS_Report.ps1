...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\REPORTSERVICE\Data\ReportFiles\1\1"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\Report"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\Report"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filename = "entQA-lis-report"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\Report"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\Report"
$numRecentBackups = 3
$numRecentLogs = 3
