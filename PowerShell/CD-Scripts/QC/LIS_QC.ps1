...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\QC"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\QC"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\QC"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename = "entQA-lis-qc"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\QC"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\QC"
$webSiteName = "LIMS_ENTERPRISE_QA"
$appPoolName = "LIMS_ENT_QA_QC"
$numRecentBackups = 3
$numRecentLogs = 3
