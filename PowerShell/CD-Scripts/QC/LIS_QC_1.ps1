...
$webSitePath = "R:\LIS_DEVTEST_DuMMY\WEBSITESERVICE\QC"
$backupPath = "R:\RMG_Auto\Backup\QC"
$timestamp = Get-Date -Format "HH-mm"
$logFile = "Log_$Version-$Build.log"
$logPath = "R:\RMG_Auto\Logs\QC"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename = "rmg-lis-qc"
$SourcePath = "R:\Jenkins_Release\RMG_LIS\QC"
$localDestPath = "R:\RMG_Auto\Migrate_Dest_Path\QC"
