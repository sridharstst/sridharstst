...
$webSitePath = "W:\LIMS_ENTERPRISE_QA\WEBSITE\BBMASTERSERVICE"
$backupPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Backups\BBMaster"
$timestamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$logFile = "Log_$Version-$Build.log"
$logPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Logs\BBMaster"
$LogFullPath = Join-Path -Path $logPath -ChildPath $logFile
$filesToCopy = @("appsettings.json", "web.config")
$filename = "entQA-lis-bbmaster"
$SourcePath = "R:\Jenkins_Release\LIS_ENT_QA\BBMaster"
$localDestPath = "W:\Automation_Script\LIMS_ENTERPRISE_QA\Migrated_Source\BBMaster"
$webSiteName = "LIMS_ENTERPRISE_QA"
$appPoolName = "LIMS_ENT_QA_BBMaster"
$numRecentBackups = 3
$numRecentLogs = 3
